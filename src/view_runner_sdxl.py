...
from viewforge.models.attention_processor import DecoupledMVRowColSelfAttnProcessor2_0
from viewforge.pipelines.pipeline_orbit_i2m_sdxl import MVAdapterI2MVSDXLPipeline
from viewforge.schedulers.scheduling_shift_snr import ShiftSNRScheduler
from viewforge.utils import make_image_grid, tensor_to_image
from viewforge.utils.mesh_utils import (
...
def prepare_pipeline(
    ...
    pipe.load_custom_adapter(
        adapter_path, weight_name="msadapter_ig2mv_sdxl.safetensors"
    )
